...
// import store from '../ui/src/store.js';
...
// const store = require('../ui/src/store.js').default;
...
if (!JWT_SECRET) {
    if (process.env.NODE_ENV !== 'production') {
        ...
        console.log('Missing env var JWT_SECRET. Authentaticat disabled');
    }
}
...
routes.post('/signout', async (req, res) => {
    // TODO cooke may not have been cleard.  refresh after log out shows loged in status
    res.clearCookie('jwt');
    res.json({ status: 'ok' });
